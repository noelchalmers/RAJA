...
HIP_TYPED_TEST_P(TypedLocalMem_gpu, Basic)
{
  using Pol = at_v<TypeParam, 0>;
...
HIP_TYPED_TEST_P(MatTranspose_gpu, Basic)
{
...
HIP_TYPED_TEST_P(MatMultiply_gpu, shmem)
{
...
HIP_TYPED_TEST_P(MatMultiplyScalar_gpu, shmem)
{
