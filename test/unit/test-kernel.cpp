...
HIP_TEST(Kernel_gpu, HipCollapse2)
{
  using Pol = RAJA::KernelPolicy<
      HipKernel<
...
HIP_TEST(Kernel_gpu, HipReduceA)
{
...
HIP_TEST(Kernel_gpu, HipReduceB)
{
...
HIP_TEST(Kernel_gpu, SubRange_ThreadBlock)
{
  using Pol = RAJA::KernelPolicy<
      HipKernel<For<0, RAJA::hip_thread_x_loop, Lambda<0>>>>;
...
HIP_TEST(Kernel_gpu, SubRange_Complex)
{
  using PolA = RAJA::KernelPolicy<
      HipKernel<
...
HIP_TEST(Kernel_gpu, ReduceHipSum1)
{
...
HIP_TEST(Kernel_gpu, ReduceHipWarpLoop1)
{
...
HIP_TEST(Kernel_gpu, ReduceHipWarpLoop2)
{
...
HIP_TEST(Kernel_gpu, ReduceHipWarpLoop3)
{
...
HIP_TEST(Kernel_gpu, HipForICount)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipTileTCount)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipConditional)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec1ab)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec1ac)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipComplexNested)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec_1blockexec)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec_2threadloop)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec_1thread1block)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec_3threadloop)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec_tile1threaddirect)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, Hyperplane_hip_2d)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, Hyperplane_hip_2d_negstride)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, Hyperplane_hip_3d_tiled)
{
  using namespace RAJA;
...
HIP_TEST(Kernel_gpu, HipExec_1threadexec)
{
  using namespace RAJA;
