                          ...
                          Index_type num_zones)
{
  ...
  ReduceSum<hip_reduce<block_size>, double> pdsum(0.0);
  ReduceMin<hip_reduce<block_size>, double> pdmin(DBL_MAX);
  ReduceMax<hip_reduce<block_size>, double> pdmax(-DBL_MAX);
  ReduceMinLoc<hip_reduce<block_size>, double> pdminloc(DBL_MAX, -1);
  ReduceMaxLoc<hip_reduce<block_size>, double> pdmaxloc(-DBL_MAX, -1);
