...
struct ForallViewHIP : ::testing::Test
{
  virtual void SetUp()
  {
    ...
    hipErrchk( hipMemcpy( arr_d, arr_h,
                            alen * sizeof(double),
...
HIP_TEST_F(ForallViewHIP, ForallViewLayout)
{
  ...
  hipErrchk( hipMemcpy( arr_h, arr_d,
              alen * sizeof(double),
...
HIP_TEST_F(ForallViewHIP, ForallViewOffsetLayout)
{
  const Index_type alen = ::alen;
  double* arr_h = ::arr_h;
  double* arr_d = ::arr_d;
...
HIP_TEST_F(ForallViewHIP, ForallViewOffsetLayout2D)
{
