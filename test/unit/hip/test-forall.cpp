...
///
HIP_TEST_F(ForallHip, forall_range)
{
...
///
HIP_TEST_F(ForallHip, forall_icount_range)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;
...
///
HIP_TEST_F(ForallHip, forall_indexset)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;
...
///
HIP_TEST_F(ForallHip, forall_icount_indexset)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;
