...
//----------------------------------------------------------------------------//
  ...
  using NESTED_EXEC_POL5 =
    RAJA::KernelPolicy<
      RAJA::statement::HipKernel<
        RAJA::statement::For<1, RAJA::hip_threadblock_exec<HIP_BLOCK_SIZE>,
          RAJA::statement::For<0, RAJA::hip_threadblock_exec<HIP_BLOCK_SIZE>,
            RAJA::statement::Lambda<0>
          >
        >
      >
...
//----------------------------------------------------------------------------//
  ...
  using EXEC_POL9 =
    RAJA::KernelPolicy<
      RAJA::statement::HipKernel<
        RAJA::statement::For<1, RAJA::hip_threadblock_exec<HIP_BLOCK_SIZE>, // row
          RAJA::statement::For<0, RAJA::hip_threadblock_exec<HIP_BLOCK_SIZE>, // col
            RAJA::statement::Lambda<0>,   // dot = 0.0
            RAJA::statement::For<2, RAJA::seq_exec,
                RAJA::statement::Lambda<1> // dot += ...
            >,
