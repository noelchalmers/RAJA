...
//----------------------------------------------------------------------------//
  ...
  // by BLOCK_SIZE arguments.
  //
  // When the matrix dimension N is an integer multiple of BLOCK_SIZE, 
    ...
    RAJA::KernelPolicy<
      RAJA::statement::HipKernel<
        RAJA::statement::For<1, RAJA::hip_block_exec,
          RAJA::statement::For<0, RAJA::hip_thread_exec,
            RAJA::statement::Lambda<0>
          >
        >
      >
...
//----------------------------------------------------------------------------//
  ...
  using EXEC_POL9 =
    RAJA::KernelPolicy<
      RAJA::statement::CudaKernel<
        RAJA::statement::For<1, RAJA::cuda_threadblock_exec<BLOCK_SIZE>, // row
          RAJA::statement::For<0, RAJA::cuda_threadblock_exec<BLOCK_SIZE>, // col
            RAJA::statement::Lambda<0>,   // dot = 0.0
            RAJA::statement::For<2, RAJA::seq_exec,
                RAJA::statement::Lambda<1> // dot += ...
            >,
...
//----------------------------------------------------------------------------//
  ...
  using EXEC_POL9 =
    RAJA::KernelPolicy<
      RAJA::statement::HipKernel<
        RAJA::statement::For<1, RAJA::hip_threadblock_exec<BLOCK_SIZE>, // row
          RAJA::statement::For<0, RAJA::hip_threadblock_exec<BLOCK_SIZE>, // col
            RAJA::statement::Lambda<0>,   // dot = 0.0
            RAJA::statement::For<2, RAJA::seq_exec,
                RAJA::statement::Lambda<1> // dot += ...
            >,
