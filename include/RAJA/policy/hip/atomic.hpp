 ...
 */
template <typename T>
RAJA_INLINE __device__ T atomicAdd(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
    return a + value;
  });
}
...
template <>
RAJA_INLINE __device__ int atomicAdd<int>(hip_atomic,
                                          int volatile *acc,
                                          int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicAdd<unsigned>(hip_atomic,
...
template <>
RAJA_INLINE __device__ float atomicAdd<float>(hip_atomic,
                                              float volatile *acc,
                                              float value)
{
...
#if __HIP_ARCH__ >= 600
template <>
RAJA_INLINE __device__ double atomicAdd<double>(hip_atomic,
                                                double volatile *acc,
                                                double value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicSub(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
    return a - value;
  });
...
template <>
RAJA_INLINE __device__ int atomicSub<int>(hip_atomic,
                                          int volatile *acc,
                                          int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicSub<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicMin(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
...
template <>
RAJA_INLINE __device__ int atomicMin<int>(hip_atomic,
                                          int volatile *acc,
                                          int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicMin<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
// 64-bit unsigned atomicMin support by HIP sm_35 and later
#if __HIP_ARCH__ >= 350
template <>
...
template <typename T>
RAJA_INLINE __device__ T atomicMax(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
    return a > value ? a : value;
  });
...
template <>
RAJA_INLINE __device__ int atomicMax<int>(hip_atomic,
                                          int volatile *acc,
                                          int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicMax<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
// 64-bit unsigned atomicMax support by HIP sm_35 and later
#if __HIP_ARCH__ >= 350
template <>
...
template <typename T>
RAJA_INLINE __device__ T atomicInc(hip_atomic, T volatile *acc, T val)
{
  // See:
  // http://docs.nvidia.com/hip/hip-c-programming-guide/index.html#atomicinc
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T old) {
...
template <>
RAJA_INLINE __device__ unsigned atomicInc<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicInc(hip_atomic, T volatile *acc)
{
  return detail::hip_atomic_CAS_oper(acc,
                                      [=] __device__(T a) { return a + 1; });
}


template <typename T>
RAJA_INLINE __device__ T atomicDec(hip_atomic, T volatile *acc, T val)
{
  // See:
...
template <>
RAJA_INLINE __device__ unsigned atomicDec<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicDec(hip_atomic, T volatile *acc)
{
  return detail::hip_atomic_CAS_oper(acc,
                                      [=] __device__(T a) { return a - 1; });
}
...
template <typename T>
RAJA_INLINE __device__ T atomicAnd(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
    return a & value;
  });
...
template <>
RAJA_INLINE __device__ int atomicAnd<int>(hip_atomic,
                                          int volatile *acc,
                                          int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicAnd<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicOr(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
    return a | value;
  });
...
template <>
RAJA_INLINE __device__ int atomicOr<int>(hip_atomic,
                                         int volatile *acc,
                                         int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicOr<unsigned>(hip_atomic,
                                                   unsigned volatile *acc,
                                                   unsigned value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicXor(hip_atomic, T volatile *acc, T value)
{
  return detail::hip_atomic_CAS_oper(acc, [=] __device__(T a) {
    return a ^ value;
  });
...
template <>
RAJA_INLINE __device__ int atomicXor<int>(hip_atomic,
                                          int volatile *acc,
                                          int value)
{
...
template <>
RAJA_INLINE __device__ unsigned atomicXor<unsigned>(hip_atomic,
                                                    unsigned volatile *acc,
                                                    unsigned value)
{
...
template <typename T>
RAJA_INLINE __device__ T atomicExchange(hip_atomic, T volatile *acc, T value)
{
