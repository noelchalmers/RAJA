 ...
 * \file
 *
 * \brief   Header file for HIP thread executors.
 *
 ******************************************************************************
 */
...
#ifndef RAJA_policy_hip_kernel_Thread_HPP
#define RAJA_policy_hip_kernel_Thread_HPP
...
struct HipStatementExecutor<Data,
  ...
  using index_calc_t = HipIndexCalc_Terminator<typename Data::segment_tuple_t>;
