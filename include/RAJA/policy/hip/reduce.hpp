...
// hip 8 only has shfl primitives for 32 bits while hip 9 has 32 and 64 bits
constexpr const size_t min_shfl_int_type_size = sizeof(int);
#if (__HIPCC_VER_MAJOR__ >= 9)
...
private:
  ...
  using reduce_data_type = typename std::
      conditional<maybe_atomic
                  ...
                  hip::ReduceAtomic_Data<Async, Combiner, T>,
                  hip::Reduce_Data<Async, Combiner, T>>::type;
...
class ReduceSum<hip_reduce<BLOCK_SIZE, Async, maybe_atomic>, T>
    : public hip::Reduce<Async, RAJA::reduce::sum<T>, T, maybe_atomic>
{

public:
  using Base = hip::Reduce<Async, RAJA::reduce::sum<T>, T, maybe_atomic>;
  using Base::Base;
...
template <size_t BLOCK_SIZE, bool Async, bool maybe_atomic, typename T>
class ReduceMin<hip_reduce<BLOCK_SIZE, Async, maybe_atomic>, T>
    : public hip::Reduce<Async, RAJA::reduce::min<T>, T, maybe_atomic>
{

public:
  using Base = hip::Reduce<Async, RAJA::reduce::min<T>, T, maybe_atomic>;
  using Base::Base;
...
template <size_t BLOCK_SIZE, bool Async, bool maybe_atomic, typename T>
class ReduceMax<hip_reduce<BLOCK_SIZE, Async, maybe_atomic>, T>
    : public hip::Reduce<Async, RAJA::reduce::max<T>, T, maybe_atomic>
{

public:
  using Base = hip::Reduce<Async, RAJA::reduce::max<T>, T, maybe_atomic>;
  using Base::Base;
...
template <size_t BLOCK_SIZE, bool Async, bool maybe_atomic, typename T>
class ReduceMinLoc<hip_reduce<BLOCK_SIZE, Async, maybe_atomic>, T>
    : public hip::Reduce<Async,
...
template <size_t BLOCK_SIZE, bool Async, bool maybe_atomic, typename T>
class ReduceMaxLoc<hip_reduce<BLOCK_SIZE, Async, maybe_atomic>, T>
    : public hip::
          Reduce<Async,
