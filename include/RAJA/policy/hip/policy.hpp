...
using hip_reduce_async = hip_reduce<BLOCK_SIZE, true, false>;

template <size_t BLOCK_SIZE>
using hip_reduce_atomic = hip_reduce<BLOCK_SIZE, false, true>;

template <size_t BLOCK_SIZE>
using hip_reduce_atomic_async = hip_reduce<BLOCK_SIZE, true, true>;
...
using policy::hip::hip_reduce_async;
using policy::hip::hip_reduce_atomic;
using policy::hip::hip_reduce_atomic_async;
